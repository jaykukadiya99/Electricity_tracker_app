  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Bulk Readings', style: TextStyle(fontWeight: FontWeight.w800, color: Color(0xFF0F172A), fontSize: 20)),
      ),
      body: Obx(() {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('BULK DATA ENTRY', style: TextStyle(color: Color(0xFF64748B), fontWeight: FontWeight.bold, fontSize: 10, letterSpacing: 1.5)),
                  ...
                  // Cost Per Unit
                  const Text('Universal Cost per Unit (₹)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF0F172A))),
                  const SizedBox(height: 8),
                  TextField(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(meter['meter_name'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF0F172A))),
                              const SizedBox(height: 4),
                              Text('Prev: $prevReading kWh', style: TextStyle(color: Colors.grey[600], fontSize: 12, fontStyle: FontStyle.italic)),
                            ],
                          ),
                        ),
                        SizedBox(
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: controller.isLoading.value ? null : () => controller.saveBulkBill(),
                  icon: const Icon(Icons.check_circle_outline, size: 20),
                  label: const Text('Save Bulk Entry', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 1.2)),
